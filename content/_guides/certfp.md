...
In the part `Auto Identity` you can choose `SASL External (Cert)` as the
`Type` for SASL External + CertFP or `SSL Client Certificate` for SSL +
CertFP. SASL External requires at least version 1.7 of Konversation.
